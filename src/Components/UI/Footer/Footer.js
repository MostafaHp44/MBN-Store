import './Footer.css'
import { master, visa, vodafone} from './icon';
import { UilAt,UilTruck,UilWindow ,UilUserExclamation,UilKeyholeCircle,UilFileContract} from '@iconscout/react-unicons'
...
<div className='menu-1'>
       <h2 style={{color:'#0069D7'}}>Help</h2>
       <div className='List-menu-1'>
        <ul className='l1'>
          <li className='li1'><a> <div> <UilAt/> Contact US</div></a></li>  
          <li className='li1'><a><div><UilTruck/> Delivery</div></a></li>  
          <li className='li1'><a><div> <UilWindow/> Blog</div></a></li>  
...
<h2 style={{color:'#0069D7'}}>UseFull Links</h2>
<div className='List-menu-2'>
<ul className='l1'>
<li className='li1'><a><div> <UilUserExclamation/> About US</div></a></li>  
<li className='li1'><a><div> <UilKeyholeCircle/> Privacy Policy</div></a></li>  
<li className='li1'><a><div> <UilFileContract/> Terms & Conditions</div></a></li>  
</ul>
</div>
</div>
...
<div className='menu-3'>
    <h2 style={{color:'#0069D7'}}>Follow US</h2>
</div>


</div>
<div className='CopyRight'>
    <div className='textofcopy'>
    <span>© 2023 MBN-Store. All rights reserved.
*FREE EYGPT Delivery for orders over £24.95.</span>
    </div>
  
<div className='PaymentWith'>
<span className='Accept'>Accept Pyment With:</span>
